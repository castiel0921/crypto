...
from okx_rest import OKXRestPoller  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Poll OKX public market data over REST with ccxt",
    )
    parser.add_argument(
        "--symbol",
        default="BTC/USDT",
        help="Unified ccxt symbol, for example BTC/USDT",
    )
    parser.add_argument(
        "--kind",
        default="ticker",
    ...
    parser.add_argument(
        "--hostname",
        default="www.okx.com",
        help="OKX REST hostname, for example www.okx.com, us.okx.com, eea.okx.com",
    )
    parser.add_argument(
        "--interval",
        type=float,
    ...
    parser.add_argument(
        ...
        type=int,
        default=10000,
        help="HTTP timeout passed to ccxt",
    )
    parser.add_argument(
        "--pretty",
        action="store_true",
